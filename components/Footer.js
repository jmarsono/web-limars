    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            ...
            <p className={styles.footerDesc}>
              Your trusted partner in kitchen equipment manufacturing and engineering solutions. Quality products, professional services.
            </p>
          ...
          <div className={styles.footerCol}>
            ...
            <ul className={styles.contactList}>
              <li>
                ...
                <span>Jl. Industri No. 123, Jakarta Barat, Indonesia 11510</span>
              </li>
              <li>
                <span className={styles.contactIcon}>📞</span>
              ...
              <li>
                ...
                <span>info@limarsteknik.co.id</span>
              </li>
              <li>
                <span className={styles.contactIcon}>💬</span>
      ...
      <div className={styles.footerBottom}>
        <div className="container">
          <p>&copy; {new Date().getFullYear()} PT. Limars Teknik Indonesia. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
