export const blogPosts = [
  {
    slug: 'tips-perawatan-kompor-komersial',
    date: '2026-03-14',
    author: 'Jules Google',
    category: 'Tips & Trick',
    ...
    id: {
      ...
      excerpt: 'Pelajari cara merawat kompor kwali range dan kompor wok Anda agar tetap efisien dan tahan lama untuk dapur restoran Anda.',
      content: `
    ...
    en: {
      title: 'Commercial Stove Maintenance Tips for Longevity and Top Performance',
      excerpt: 'Learn how to maintain your kwali range and wok stoves to keep them efficient and durable for your restaurant kitchen.',
      content: `
  ...
  {
    slug: 'manfaat-sistem-ducting-restoran',
    date: '2026-03-10',
    author: 'Jules Google',
    ...
    id: {
      ...
      excerpt: 'Sistem sirkulasi udara yang buruk dapat mengganggu kenyamanan pelanggan dan kesehatan staf. Simak mengapa ducting berkualitas sangat krusial.',
      content: `
    ...
    en: {
      title: 'Benefits of a Good Ducting System in Your Restaurant',
      excerpt: 'Poor air circulation can affect customer comfort and staff health. Find out why quality ducting is crucial for your business.',
      content: `
  ...
  {
    slug: 'cara-memilih-oven-pizza-komersial',
    date: '2026-06-16',
    author: 'SEO Team',
    ...
    id: {
      ...
      excerpt: 'Mencari oven pizza komersial terbaik? Pahami jenis-jenis oven, sumber energi, dan cara mendapatkan oven pizza komersial harga terbaik untuk bisnis kuliner Anda.',
      content: `
    ...
    en: {
      title: 'How to Choose a Commercial Pizza Oven for Your Restaurant',
      excerpt: 'Looking for the best commercial pizza oven? Understand the oven types, power sources, and how to get the best commercial pizza oven price for your business.',
      content: `
  ...
  {
    slug: 'biaya-instalasi-gas-dapur-restoran',
    date: '2026-06-16',
    author: 'Tech Advisor',
    category: 'Service Guide',
    ...
    id: {
      ...
      excerpt: 'Rencanakan dapur komersial Anda dengan aman. Pelajari rincian faktor penentu, tabel estimasi harga, dan total biaya instalasi gas dapur restoran di Jakarta.',
      content: `
    ...
    en: {
      title: 'How Much Does Restaurant Gas Installation Cost in Jakarta?',
      excerpt: 'Plan your commercial kitchen layout safely. Learn about cost factors, price estimations table, and overall gas installation cost in Jakarta.',
      content: `
  ...
  {
    slug: 'perbedaan-wok-range-dan-kwali-range',
    date: '2026-06-15',
    ...
    id: {
      ...
      excerpt: 'Kebingungan memilih kompor restoran? Pahami perbedaan mendasar, fungsi masak, dan tabel perbandingan wok range vs kwali range untuk dapur Anda.',
      content: `
    ...
    en: {
      title: 'Differences Between Wok Range and Kwali Range: Which is Right?',
      excerpt: 'Confused about choosing a commercial stove? Understand the differences, cooking styles, and comparison table for wok range vs kwali range.',
      content: `
  ...
  {
    slug: 'tips-merawat-kitchen-set-stainless-steel',
    date: '2026-06-15',
    ...
    id: {
      ...
      excerpt: 'Mencegah karat dan menjaga kebersihan dapur komersial. Pelajari cara merawat kitchen set restoran berbahan stainless steel dengan benar dan aman.',
      content: `
    ...
    en: {
      title: 'Tips for Maintaining Stainless Steel Kitchen Sets for Longevity',
      excerpt: 'Prevent rust and maintain commercial kitchen hygiene. Learn how to clean and care for a stainless steel restaurant kitchen set safely.',
      content: `
  ...
  {
    slug: 'panduan-sistem-ducting-dapur-komersial',
    date: '2026-06-15',
    ...
    id: {
      ...
      excerpt: 'Udara bersih dan bebas asap di restoran Anda. Pelajari cara kerja, regulasi teknis, dan rancangan sistem ducting dapur komersial Jakarta yang benar.',
      content: `
    ...
    en: {
      title: 'Complete Guide to Commercial Kitchen Ducting Systems',
      excerpt: 'Ensure clean air and smoke-free dining. Learn about the mechanics, safety regulations, and layout design of commercial kitchen ducting systems in Jakarta.',
      content: `
